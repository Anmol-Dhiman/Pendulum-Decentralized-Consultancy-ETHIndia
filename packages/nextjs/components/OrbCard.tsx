  ...
  return (
    <div className="p-10 bg-white shadow-lg rounded-lg">
      <div className="flex items-center justify-start gap-10">
        ...
        <Link className="hover:text-blue-600" href={orbTotalDetails?.expertDetails.desc === undefined ? "/" : orbTotalDetails.expertDetails.desc}>
      ...
      <div className="flex justify-evenly">
        <div className="">
          ...
          <div className="text-gray-400 w-[400px]">
            ...
            <div className="flex justify-between">
              <p>Slot</p>
              <p>{`${Math.floor(365 / (Number(orbTotalDetails?.orbsDetails.coolDownTime) / (60 * 60 * 24)))}/month`} </p>
            </div>
            <div className="flex justify-between">
              <p>Harberger Tax</p>
